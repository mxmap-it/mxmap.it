...
**22886 enti** analizzati. Confidenza media **0.851** (mediana 0.9; media esclusi unknown 0.875).

## 1. Distribuzione aggregata della confidenza

| fascia | enti | % |
|---|---:|---:|
| 0.90-1.00 (molto alta) | 17366 | 75.9% |
...
|---|---:|---:|---:|---:|
| google | 6437 | 0.883 | 0.80 | 0.92 |
| aruba | 5136 | 0.896 | 0.80 | 0.92 |
| microsoft | 3438 | 0.929 | 0.80 | 0.96 |
...
**Domestic MX override** applicato a **200** enti: classificati cloud (Microsoft/Google) per segnale tenant/DKIM, ma con MX in entrata self-hosted domestico → riclassificati `independent` (il tenant cloud riflette Teams/SharePoint, non la posta).
