...
| fascia | enti | % |
|---|---:|---:|
| 0.90-1.00 (molto alta) | 17367 | 75.9% |
| 0.80-0.89 (alta) | 3592 | 15.7% |
...
|---|---:|---:|---:|---:|
| google | 6436 | 0.883 | 0.80 | 0.92 |
| aruba | 5142 | 0.896 | 0.80 | 0.92 |
| microsoft | 3430 | 0.929 | 0.80 | 0.96 |
| independent | 3036 | 0.720 | 0.50 | 0.80 |
| local-isp | 1548 | 0.892 | 0.80 | 0.92 |
| regional-public | 934 | 0.895 | 0.80 | 0.90 |
...
| giurisdizione | enti | % |
|---|---:|---:|
| 🇮🇹 Domestica (IT) | 10516 | 46.0% |
| Mista (IT + estero) | 244 | 1.1% |
| 🌍 Estera | 11429 | 49.9% |
| Sconosciuta | 695 | 3.0% |

**Domestic MX override** applicato a **199** enti: classificati cloud (Microsoft/Google) per segnale tenant/DKIM, ma con MX in entrata self-hosted domestico → riclassificati `independent` (il tenant cloud riflette Teams/SharePoint, non la posta).
